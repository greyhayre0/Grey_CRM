...
urlpatterns = [
    ...
    path("closed/", all_deals, name="closed_deals"),
    path("services/", services, name="services"),
    path("deal/delete/<int:deal_id>/", delete_deal, name="delete_deal"),
    path("closed/<int:deal_id>/", deal_detail, name="deal_detail"),
    path("deal/create/", create_deal, name="create_deal"),
    path(
        "deal/<int:deal_id>/update_status/",
        update_deal_status,
        name="update_deal_status",
    ),
    # API endpoints
    path("api/services/", create_service_api, name="create_service_api"),
    ...
    path("client/<int:client_id>/deals/", client_deals, name="client_deals"),
    # ... другие маршруты ...
    path("api/find_client/", find_client_api, name="find_client_api"),
]
